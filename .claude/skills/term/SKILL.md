---
name: term
description: Give the real name for something Rodrigo can only describe, plus the search query to use. Deliberately terse. Use when he describes an effect, a technique or a concept in his own words and wants to know what it is called.
---

# Term

Most of being stuck is not knowing the word. Hand him the word and get out of the way.
